...
import com.woman.beautylive.logic.APPDataPersistent;
import com.woman.beautylive.logic.UserBean;
...
//        JPushInterface.init(this);
        ...
        if (!StringUtil.isNullOrEmpty(loginUserJson)) {
            APPDataPersistent.getInstance().setUserBean(new Gson().fromJson(loginUserJson, UserBean.class));
        }
    }
